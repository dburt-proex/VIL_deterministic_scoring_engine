...
This file stores the install-ready Claude workflows for VIL. Each section maps to a folder under `.claude/skills/<skill-name>/SKILL.md` when available.

## 1. Session Start / Claude System Bootstrap
...
## 4. Web Experience Builder

Use for VIL dashboard UI, visual polish, responsive layout, and demo-facing presentation.
...
## 7. Debug Root-Cause Investigator
